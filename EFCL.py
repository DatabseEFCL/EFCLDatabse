...
if file_uploaded:
    ...
    if Qst == "Program":
            ...
            Community= df["Community League"].loc[df['Program']== Program_ch].drop_duplicates().sort_values()
            Delivery = df["Delivery"].loc[df['Program']== Program_ch].drop_duplicates().sort_values()
